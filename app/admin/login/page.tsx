  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md items-center px-4 py-10">
      <section className="w-full rounded-xl border border-zinc-800 bg-zinc-900/60 p-6 shadow-none backdrop-blur">
        <h1 className="text-2xl font-semibold tracking-tight text-zinc-50">Admin Login</h1>
        <p className="mt-2 text-sm text-zinc-400">
          Use your Supabase email/password credentials.
        </p>
        <div className="mt-6">
          <Suspense fallback={<div className="text-sm text-zinc-400">Loading login form...</div>}>
            <LoginForm />
          </Suspense>
        </div>
      </section>
